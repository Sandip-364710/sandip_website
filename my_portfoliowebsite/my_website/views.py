...
class HomePageView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['frontend_skills'] = SkillsView.objects.filter(category='Frontend Development')
...
class UserLoginView(LoginView):
    ...
    def form_invalid(self, form):
        ...
        if failed_attempts >= 5:
            messages.warning(self.request, 'Too many failed attempts. Redirecting to signup.')
